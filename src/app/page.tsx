...
export default function HomePage() {
  ...
  return (
    <div className="flex h-full">
      {/* Client List — full width on mobile when no client selected, fixed width on desktop */}
      <div className={`bg-surface-container-low flex flex-col transition-all duration-200
      ...
      {/* Detail panel — full width on mobile when client selected */}
        ...
        {selectedClient ? (
          <>
            ...
            <button
              ...
              className="md:hidden mb-4 flex items-center gap-1.5 text-sm text-on-surface-variant hover:text-on-surface transition-colors">
          ...
          <div className="hidden md:flex flex-col items-center justify-center h-full text-on-surface-variant">
